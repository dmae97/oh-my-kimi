...
class MultiHeadLatentAttention(nn.Module):
    def __init__(self, d_model, n_heads, d_head=None, kv_rank=None, q_rank=None, rope_dim=None):
        super().__init__()
        self.h = n_heads
        ...
        self.q_up = nn.Linear(self.q_rank, self.h * self.dh, bias=False)          # nope+rope split
        ...
        self.kv_up = nn.Linear(self.kv_rank, self.h * (self.nope + self.dh), bias=False)  # k_nope + v
