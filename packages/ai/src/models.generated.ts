...
export const MODELS = {
	...
	"openai-codex": {
		...
		"gpt-5.6-luna": {
			...
			baseUrl: "https://chatgpt.com/backend-api",
			reasoning: true,
			thinkingLevelMap: {"xhigh":"xhigh","max":"xhigh","minimal":"low"},
			input: ["text", "image"],
			cost: {
				input: 1,
				output: 6,
		...
		"gpt-5.6-moa": {
			...
			baseUrl: "https://chatgpt.com/backend-api",
			reasoning: true,
			thinkingLevelMap: {"xhigh":"xhigh","max":"xhigh","minimal":"low","ultra":"xhigh"},
			input: ["text", "image"],
			cost: {
				input: 0,
				output: 0,
	...
	"together": {
		...
		"zai-org/GLM-5.2": {
			...
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsReasoningEffort":false,"maxTokensField":"max_tokens","supportsStrictMode":false,"supportsLongCacheRetention":false,"thinkingFormat":"together"},
			reasoning: true,
			thinkingLevelMap: {"minimal":null,"low":"low","medium":"medium","off":null,"high":"high","xhigh":"xhigh","max":"max"},
			input: ["text"],
			cost: {
				input: 1.4,
				output: 4.4,
