#!/usr/bin/env bash
#
# Build OMK binaries for all platforms locally.
...
#     omk-darwin-arm64.tar.gz
#     omk-darwin-x64.tar.gz
#     omk-linux-x64.tar.gz
#     omk-linux-arm64.tar.gz
#     omk-windows-x64.zip
#     omk-windows-arm64.zip
